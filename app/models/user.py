...
class User(Base):
    ...
    team_category = Column(String, nullable=True)     # Séniors, U19...
    filming_setup = Column(String, nullable=True)     # smartphone_hand,drone,...
    experience = Column(String, nullable=True)        # 1 an, 2-5 ans, +5 ans, +10 ans
